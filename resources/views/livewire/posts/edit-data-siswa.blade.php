<div class="p-6">
    ...
    <div class="bg-white rounded-md border border-gray-100 shadow-md shadow-black/5">
                    ...
                    <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5 ">
                        ...
                        <x-header title="Foto Profil"  size="text-x" separator />
                            <x-file wire:model="foto" class="-mt-6 flex justify-center" accept="image/png, image/jpeg" 
                                ...
                                @else
                                    src="{{ $foto->avatar ?? asset('assets/img/empty-user.png') }}"
                                @endif  class="h-40 rounded-full border-2 border-blue-500 mt-2" />
                            </x-file>
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-6 mb-6">
                        ...
                        <div class="grid gap-4 grid-cols-1">
                            ...
                            <div class="flex space-x-3">
                                <div class="flex items-center">
                                    <input wire:model="status_ayah" wire:click="toggleDisabled('ayah', 'false')" id="sts_hidup_ayah" type="radio" value="Hidup" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="sts_hidup_ayah" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Masih Hidup</label>
                                </div>
                                <div class="flex items-center">
                                    <input wire:model="status_ayah" wire:click="toggleDisabled('ayah', 'true')" checked id="sts_tdk_ayah" type="radio" value="Meninggal" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            ...
                            <div class="grid grid-cols-2 gap-2 lg:grid-cols-2">
                                ...
                                <div class="flex items-center ml-3">
                                    <input wire:click="toggleDisabledHP('ayah')"  type="Checkbox" id="DisabledAyahHP" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" @if ($isDisabledAyah) disabled @endif @if($isCheckedAyah) checked @endif>
                    ...
                    <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5 ">
                        ...
                        <div class="grid gap-4 grid-cols-1">
                            ...
                            <div class="flex space-x-3">
                                <div class="flex items-center">
                                    <input wire:click="toggleDisabled('ibu', 'false')" id="default-radio-1" type="radio" wire:model="status_ibu" value="Hidup" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="default-radio-1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Masih Hidup</label>
                                </div>
                                <div class="flex items-center">
                                    <input wire:click="toggleDisabled('ibu', 'true')" id="default-radio-2" type="radio" wire:model="status_ibu" value="Meninggal" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="default-radio-2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Sudah Meninggal</label>
                                </div>
                                <div class="flex items-center">
                                    <input wire:click="toggleDisabled('ibu', 'true')" id="default-radio-3" type="radio" wire:model="status_ibu" value="Tidak Diketahui" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div class="grid gap-4 grid-cols-1">
                            ...
                            @elseif ($wali === 'Lainnya')
                                ...
                                <div class="grid grid-cols-2 gap-2 lg:grid-cols-2">
                                    ...
                                    <div class="flex items-center ml-3">
                                        <input @click="isDisabledWaliHP" wire:click="toggleDisabledHP('wali')"  type="Checkbox" id="DisabledWaliHP" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        ...
        <div class="flex justify-between p-6">
            ...
            @if ($currentStep > 2)
                <x-button wire:click="updateForm" label="Simpan" class="text-white bg-green-500" spinner />
            @endif
